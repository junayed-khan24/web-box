      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="text-xl md:text-2xl font-bold text-pink-700">
              <span className="text-2xl md:text-3xl">W</span>eb<span className="text-2xl md:text-3xl">B</span>ox
            </Link>
          </div>
          ...
          <div className="hidden md:flex space-x-8 items-center text-1xl font-bold">
            ...
            <Link to="/aboutClub" className="text-gray-700 hover:text-pink-600">
              About
            </Link>
            <Link
              to="/services"
